 ...
 * der Population darstellt, Schaltknöpfen zur Steuerung der Simulation und
 * einem zusätzlichen Fenster, welches erlaubt Simulationsoptionen zu setzen.
 * 
 * @author Frank Lesske / C. Brand
 */
public class SimulatorAnzeige extends JFrame implements ActionListener,
    ChangeListener {
  // Farbe für leere Felder
  private static final Color EMPTY_COLOR = Color.white;

  // Farbe für unbekannte Objekte
  ...
  /**
   * Erzeuge eine Anzeige der gegebenen Breite und Höhe
   */
   ...
   * @param feld
   *            Für welches Feld soll der Zustand dargestellt werden.
   */
  public void showStatus(int step, Feld feld, String pop) {
    ...
    for (int row = 0; row < feld.getHeight(); row++) {
      for (int col = 0; col < feld.getWidth(); col++) {
        ...
        if (objekt != null) {
          // falls statt Bilder lieber gefüllte Rechtecke erwünscht sind
          // so ändere hier den Aufruf auf
   ...
   * Komponente f�r die grafische Benutzerschnittstelle definiert. Diese
   * Komponente zeigt das Feld an. Hierbei handelt es sich um
   * fortgeschrittenes Programmieren - für das Projekt müssen Sie das nicht
   * unbedingt verstehen.
   */
  private class FieldView extends JPanel {
    ...
    /**
     * Bevorzugte Größe für den GUI Manager.
     */
    ...
    /**
     * Vorbereitung für die graphische Darstellung des Feldes.
    ...
    /**
     * Fülle eine Positionim Feld mit einer Farbe
     */
